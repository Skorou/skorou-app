 ...
 */
final class Version20200913183929 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, address1 VARCHAR(255) NOT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, zipcode VARCHAR(10) NOT NULL, country VARCHAR(100) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, is_favorite TINYINT(1) NOT NULL, INDEX IDX_D4E6F81A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE color (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, hexa VARCHAR(6) NOT NULL, INDEX IDX_665648E9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE creation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, folder_id INT DEFAULT NULL, name VARCHAR(256) NOT NULL, data JSON NOT NULL, INDEX IDX_57EE8574A76ED395 (user_id), INDEX IDX_57EE8574162CB942 (folder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE creation_creation_type (creation_id INT NOT NULL, creation_type_id INT NOT NULL, INDEX IDX_405FE32834FFA69A (creation_id), INDEX IDX_405FE328E54D5EF8 (creation_type_id), PRIMARY KEY(creation_id, creation_type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE creation_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, order_index INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE logo (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, file VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_E48E9A13A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, user_id INT NOT NULL, credit_card_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, payment_type SMALLINT NOT NULL, price DOUBLE PRECISION NOT NULL, invoice VARCHAR(255) NOT NULL, INDEX IDX_A3C664D3F5B7AF75 (address_id), INDEX IDX_A3C664D3A76ED395 (user_id), INDEX IDX_A3C664D37048FD0F (credit_card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, account_type SMALLINT NOT NULL, company_name VARCHAR(50) NOT NULL, company_picture VARCHAR(255) DEFAULT NULL, free_creations INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE creation_creation_type ADD CONSTRAINT FK_405FE32834FFA69A FOREIGN KEY (creation_id) REFERENCES creation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE creation_creation_type ADD CONSTRAINT FK_405FE328E54D5EF8 FOREIGN KEY (creation_type_id) REFERENCES creation_type (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE creation_creation_type DROP FOREIGN KEY FK_405FE32834FFA69A');
        $this->addSql('ALTER TABLE template_creation_category DROP FOREIGN KEY FK_2D326A0152191D37');
        $this->addSql('ALTER TABLE creation_creation_type DROP FOREIGN KEY FK_405FE328E54D5EF8');
        ...
        $this->addSql('ALTER TABLE template_creation_category DROP FOREIGN KEY FK_2D326A015DA0FB8');
        ...
        $this->addSql('DROP TABLE creation_creation_type');
