 ...
 */
final class Version20210518152847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, company_name VARCHAR(50) NOT NULL, company_picture VARCHAR(255) DEFAULT NULL, free_creations INT NOT NULL, is_active TINYINT(1) DEFAULT NULL, is_verified TINYINT(1) DEFAULT NULL, roles JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
